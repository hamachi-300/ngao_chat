...
export async function GET(request) {
    ...
    const discordClientSecret = 't4QcuVUuqXXJcmMbVb00QwXgyV87rxbe'; // Replace with your Discord Client Secret
    ...
    if (!data.access_token) {
        ...
        return NextResponse.redirect('/login'); // Redirect the user to login page
    }
    ...
    const res = NextResponse.redirect('/home'); // Redirect to the home page after login
